...
WF183DE_OWI_Sensor::WF183DE_OWI_Sensor(uint32_t update_interval, InternalGPIOPin *pin, uint64_t address)
    : PollingComponent(update_interval), DallasComponent(pin), address_(address) {}
